...
class ResourceBrowser(html.HTMLElement):
    ...
    .. attribute:: breadcrumb_template
        ...
        This is a template used to render the breadcrumb. Defaults to ``None``.
    """
    name = None
    verbose_name = None
    ...
    def set_tables(self, tables):
        ...
        if self.has_breadcrumb:
            self.prepare_breadcrumb(self.content_table)

    def prepare_breadcrumb(self, table):
